...
export default function ChatScreen() {
  ...
  /** Déclenche l'analyse Gemini Red/Green flags tous les 20 messages */
  useEffect(() => {
        ...
        <View style={styles.headerWrapper}>
          <View style={styles.headerRow}>
            ...
            <FlagGaugeIndicator
              ...
              red={flagScores.red}
              colors={colors}
              onPress={() => router.push(`/(app)/flags/${conversationId}`)}
            />
